    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-indigo-700 py-12">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-center md:justify-start text-center md:text-left">
            <div className="flex-shrink-0 mx-auto md:mx-0 bg-white rounded-full p-2 shadow-lg mb-6 md:mb-0 md:mr-8">
              <img
      ...
      {/* Main Content */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 sm:-mt-12 mb-16">
